...
class ViewGroupAdapter(var context: Context, val mode: Int = MODE_NORMAL) :
    PagingDataAdapter<Video, ViewGroupAdapter.VideoHolder>(VideoComparator), OnItemClickListener {
